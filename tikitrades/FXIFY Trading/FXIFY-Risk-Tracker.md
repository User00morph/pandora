...
_Converted from `FXIFY-Risk-Tracker.xlsx` — source workbook is the system of record; this file is a readable snapshot for transfer/extraction._
...
|---|---|---|---|---|---|---|---|
| 200K (Phase 1) | $200,000.00 | 3.0% | $6,000.00 | 6.0% | $12,000.00 | 0.25–0.51% | $201,178.33 |
| 100K (not started) | $100,000.00 | 3.0% | $3,000.00 | 6.0% | $6,000.00 | 0.25–0.51% | $100,000.00 |

_Risk % per Trade corrected 2026-07-26 — the prior "2.0%" figure was stale and didn't match actual practiced sizing (0.33 gold / 2.00 GJ lots ≈ 0.25–0.51% per trade, verified against 10 days of fills and confirmed by Tiki directly). Since the source workbook (`FXIFY-Risk-Tracker.xlsx`) is the system of record, this figure should also be corrected there._
...
|---|---|---|---|---|---|---|---|
| 200K (Phase 1) | 2026-07-24 | $194,746.06 | $2,954.98 | 49.8% | $5,567.73 | 46.4% | STOP - ONE LOSS FROM DAILY BREACH |
| 100K | - | - | - | - | - | - | - |
...
| 2026-07-23 | $197,722.76 | $194,575.48 | $3,147.28 | $5,837.26 | $0.00 | 0.0% | $5,837.26 | $201,178.33 | $12,000.00 | $3,455.57 | 28.8% | $8,544.43 | OK |
| 2026-07-24 | $194,746.06 | $197,722.76 | $-2,976.70 | $5,931.68 | $2,976.70 | 50.2% | $2,954.98 | $201,178.33 | $12,000.00 | $6,432.27 | 53.6% | $5,567.73 | STOP - ONE LOSS FROM DAILY BREACH |
...
- **2026-07-23**: A+ short off 4,066 OB/EMA rejection after jobless-claims-driven selloff. Partials into 4,040 weak-low sweep, trailed to BE. One trade, followed plan. Day +$3,147.28.
- **2026-07-24**: EOD close per DXtrade acct 1849940 (Sun weekend balance). Fri Jul 24 was a LOSING day: 197,771 -> 194,746 = -$3,025 (~50% of daily limit) traded in the 4,068-4,090 midrange chop, at 0.66 (2x) size per ticket. 0.33 flag STILL not cleared.
